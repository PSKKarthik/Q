        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(self "https://meet.jit.si"), microphone=(self "https://meet.jit.si"), geolocation=(), payment=()' },
          {
            ...
            value: [
              ...
              "font-src 'self'",
              "connect-src 'self' https://udfzxrmvbyfesxutklof.supabase.co wss://udfzxrmvbyfesxutklof.supabase.co https://api.groq.com https://meet.jit.si wss://meet.jit.si",
              "media-src 'self' https://udfzxrmvbyfesxutklof.supabase.co blob:",
              "frame-src 'self' https://udfzxrmvbyfesxutklof.supabase.co https://meet.jit.si www.youtube-nocookie.com www.youtube.com docs.google.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
